...
Source0: http://pypi.python.org/packages/source/s/%{realname}/%{realname}-%{version}%{?prever}.tar.gz
...
mkdir -p %{buildroot}/%{_localstatedir}/log/%{realname}
chmod 770 %{buildroot}/%{_localstatedir}/log/%{realname}
...
%changelog
* Sun Feb 12 2012 Silas Sewell <silas@sewell.org> - 3.0-0.6.a12
- Update to 3.0a12
- Namespace for el
